...
export const others: OtherRec[] = [
  { recordId: 'o1', nomi: 24, comments: [{ user: 'sake_to_sakana', avatar: '肴', avatarBg: '#D9C9B8', time: '1時間前', text: '本丸との出会いは事件ですよね。おめでとうございます!' }, { user: 'nihonshu_gaku', avatar: '學', avatarBg: '#CBD8C9', time: '40分前', text: 'どちらのお店ですか?巡礼したい…' }], user: 'kuramoto_taro', avatar: '蔵', avatarBg: '#C9D3E3', time: '2時間前', place: '立ち飲み わさび(大阪)', brandId: 'juyondai', rating: 5, x: 70, y: 38, sweet: 40, temps: ['冷酒'], pairing: '白子ポン酢', memo: 'やっと出会えた。立ち香は控えめ、含むと一気に開く。甘みの輪郭が綺麗で後口は静か。', date: '6月12日' },
  { recordId: 'o2', nomi: 9, comments: [], user: 'sake_to_sakana', avatar: '肴', avatarBg: '#D9C9B8', time: '5時間前', place: '自宅', brandId: 'sharaku', rating: 4, x: 55, y: 36, sweet: 50, temps: ['冷酒'], pairing: '刺身盛り', memo: '寫樂はいつも期待を裏切らない。個人的には千本錦より五百万石派。刺身との相性が抜群。', date: '6月12日' },
  { recordId: 'o3', nomi: 31, comments: [{ user: 'meigara_hunter', avatar: '探', avatarBg: '#D9C9B8', time: '昨日', text: '開栓2日目の変化もぜひ。酸が出てまた違う表情になります' }], user: 'nihonshu_gaku', avatar: '學', avatarBg: '#CBD8C9', time: '昨日', place: '酒屋で購入', brandId: 'hanaabi', rating: 5, x: 74, y: 18, sweet: 22, temps: ['冷酒'], pairing: 'チーズ', memo: 'パイナップル!としか言いようがない。抽選で当てた甲斐があった。開栓直後の香りは事件。', date: '6月11日' },
  { recordId: 'o4', nomi: 18, comments: [{ user: 'tanrei_niigata', avatar: '辛', avatarBg: '#C9D3E3', time: '昨日', text: '50度説、同意です。上がり燗より戻りの方が甘みが乗りますよね' }], user: 'kanzake_kaori', avatar: '燗', avatarBg: '#E0CDB9', time: '昨日', place: 'おでん屋 ふくべ(東京)', brandId: 'denshu', rating: 5, x: 50, y: 62, sweet: 45, temps: ['ぬる燗', '熱燗'], pairing: 'おでん(大根・牛すじ)', memo: '熱燗からの戻り際、50度くらいが一番うまい。出汁との一体感に黙る。', date: '6月11日' },
  { recordId: 'o5', nomi: 6, comments: [], user: 'tanrei_niigata', avatar: '辛', avatarBg: '#C9D3E3', time: '2日前', place: '居酒屋 こまち(新潟)', brandId: 'kubota', rating: 4, x: 20, y: 70, sweet: 78, temps: ['冷酒', '常温'], pairing: 'イカの塩辛', memo: '派手さはないが、塩辛と合わせると無限。淡麗辛口はやはり新潟の正義。', date: '6月10日' },
  { recordId: 'o6', nomi: 11, comments: [], user: 'awa_hajime', avatar: '泡', avatarBg: '#CBD8C9', time: '3日前', place: '角打ち 油長(奈良)', brandId: 'kazenomori', rating: 4, x: 46, y: 16, sweet: 60, temps: ['冷酒'], pairing: '天ぷら盛り合わせ', memo: '搾りたてのガス感。天ぷらの油をシュワッと流してくれる。低アルで飲み疲れしないのも◎。', date: '6月9日' },
  { recordId: 'o7', nomi: 15, comments: [], user: 'meigara_hunter', avatar: '探', avatarBg: '#D9C9B8', time: '4日前', place: '鮨 さが(佐賀)', brandId: 'nabeshima', rating: 5, x: 60, y: 28, sweet: 55, temps: ['冷酒'], pairing: 'イカの活造り', memo: '地元で飲む鍋島は格別。果実味とガス感、イカの甘みと完璧な三重奏。', date: '6月8日' },
  { recordId: 'o8', nomi: 21, comments: [{ user: 'kuramoto_taro', avatar: '蔵', avatarBg: '#C9D3E3', time: '4日前', text: '寝かせ而今、羨ましい。私は我慢できた試しがありません' }], user: 'jikon_daisuki', avatar: '而', avatarBg: '#DDD3BE', time: '5日前', place: '自宅', brandId: 'jikon', rating: 5, x: 66, y: 32, sweet: 58, temps: ['冷酒'], pairing: '鰆の西京焼き', memo: '半年寝かせた特別純米。角が取れて甘みがまろやかに。我慢した自分を褒めたい。', date: '6月7日' },
];
