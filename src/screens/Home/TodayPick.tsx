...
export function TodayPick({ vals }: { vals: Vals }) {
  return (
    <article
      onClick={vals.todayClick}
    ...
    >
      ...
      <section className="flex flex-col gap-2">
        ...
        <h2 className="font-serif text-[21px] font-bold leading-[1.5] m-0">{vals.today.name}</h2>
        <p className="text-[12px] text-muted m-0">{vals.today.sub}</p>
